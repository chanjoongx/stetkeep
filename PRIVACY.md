...
- Does not read files outside the target project directory
- Does not transmit code, prompts, or usage data to any server
...
Any future changes to this policy will be committed to this file in the repository. Check the git history for revisions.
